package com.wwx.wwx_crm.config;

import at.pollux.thymeleaf.shiro.dialect.ShiroDialect;
import com.wwx.wwx_crm.shiro.EmpRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager){
        ...
        //给url设置权限 （写完realm的授权之后）
        filterMap.put("/emp/list", "perms[emp:list]");
        filterMap.put("/emp/add","perms[emp:add]");
        filterMap.put("/emp/del","perms[emp:del]");
        filterMap.put("/emp/edit","perms[emp:edit]");
